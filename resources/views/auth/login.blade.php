<x-guest-layout icon="cog" caption="Panel Admin & Staff">
    ...
    <div class="mt-6 pt-4 border-t dark:border-gray-700 text-center text-sm text-gray-600 dark:text-gray-400">
        Siswa? <a href="{{ route('siswa.login') }}" class="underline text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300">Login / daftar di portal siswa</a>
    </div>
</x-guest-layout>
