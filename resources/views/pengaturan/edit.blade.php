        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mt-4">
            ...
            <div class="mt-3">
                <x-confirm-form :action="route('pengaturan.lokasi')" method="PUT"
                                 ...
                                 message="Titik sekolah, radius, dan pengecekan lokasi absen akan dihapus. Kalau ingin diaktifkan lagi, titik sekolah harus diklik ulang di peta."
                                 confirm-label="Nonaktifkan"
                                 trigger-class="text-sm text-gray-600 dark:text-gray-400 hover:underline px-0 py-1">
                    <x-slot:fields>
