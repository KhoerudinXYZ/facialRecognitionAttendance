<x-siswa-layout>
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest font-jakarta mt-1">Formulir Izin & Sakit</p>
        </div>
                ...
                <div class="relative z-10 space-y-5">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <span class="font-black text-xl text-slate-800 dark:text-slate-100 font-outfit capitalize">{{ $pengajuanHariIni->jenis }}</span>
                        </div>
                    ...
                    <form method="POST" action="{{ route('siswa.izin.store') }}" enctype="multipart/form-data" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input id="bukti" type="file" name="bukti" accept="image/*" required
                                   class="block mt-2 w-full text-sm text-slate-600 dark:text-slate-400 file:mr-3 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-black file:font-lexend file:bg-indigo-500 file:text-white hover:file:bg-indigo-600 file:shadow-md file:shadow-indigo-500/20 file:transition-all file:duration-300 border-2 border-slate-200 dark:border-slate-700 p-2 rounded-2xl bg-white/60 dark:bg-slate-900/50 shadow-inner backdrop-blur-sm" />
