<x-guest-layout icon="user-circle" caption="Portal Absensi Siswa">
    ...
    <h1 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-1">Registrasi Siswa</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
        Masukkan NIS yang sudah didaftarkan oleh wali kelas/admin, lalu buat username &amp; password sendiri.
    </p>
    ...
    <form method="POST" action="{{ route('siswa.register') }}">
        ...
        <a class="block mt-4 text-center text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200" href="{{ route('siswa.login') }}">
            Sudah punya akun? <span class="text-indigo-600 dark:text-indigo-400 font-medium">Login</span>
        </a>
    </form>
