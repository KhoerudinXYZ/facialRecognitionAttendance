    ...
    <div class="py-8 max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex gap-6">
            ...
            <div class="space-y-1">
                ...
                @if ($siswa->isRegistered())
                    <x-confirm-form :action="route('siswa.resetAccount', $siswa)" method="PUT" title="Reset akun login siswa ini?"
                                     message="Siswa harus registrasi ulang dengan NIS." confirm-label="Reset Akun"
                                     trigger-class="inline-flex items-center gap-1 text-sm text-red-600 dark:text-red-400 hover:underline">
