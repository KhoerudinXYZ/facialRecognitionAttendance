...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
    ...
    <div>
        ...
        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Dipakai untuk notifikasi WhatsApp kehadiran & alpha (kalau kanal WhatsApp aktif di server). Kosongkan kalau belum ada.</p>
    </div>
