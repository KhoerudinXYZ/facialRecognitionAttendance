...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Kode aplikasi sudah aman di git (lihat DEPLOYMENT.md) — yang
                 * benar-benar butuh dibackup di sini cuma file yang di-upload
                 * pengguna (foto siswa), bukan seluruh base_path(). Ini juga
                 * menghindari .env (kredensial DB, APP_KEY) ikut tersalin ke
                 * dalam arsip backup tanpa perlu.
                 */
                'include' => [
